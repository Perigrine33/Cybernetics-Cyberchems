...
public class RoidAutoinjector extends BaseAutoinjectorItem {
    ...
    protected Optional<String> getDurationTranslationKey() {
        return Optional.of("item.cyberchems.roid_autoinjector.duration");
    }

    protected Optional<String> getDescriptionTranslationKey() {
        return Optional.of("item.cyberchems.roid_autoinjector.desc");
    }

    @Override
    public List<MobEffectInstance> getSpinalInjectionEffects(ItemStack stack) {
        return List.of(new MobEffectInstance(ModEffects.ROID, EFFECT_DURATION, EFFECT_AMPLIFIER));
    }
}